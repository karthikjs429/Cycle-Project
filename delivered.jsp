...
<%
    ...
    if (request.getParameter("delivered") != null) {
        String upt = "update tbl_orderhead set od_headstatus='delivered' where od_id='" + request.getParameter("delivered") + "'";
        boolean u = con.insert(upt);
        if (u) {
%>
<script>alert('Delivered');window.location.href = 'pendinglist.jsp';</script>
<%
    }
} 
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <%                                
                                    int a = 0;
                                    String sel = "select * from tbl_orderhead od inner join tbl_payment p on od.pm_id=p.pm_id where od_headstatus='delivered'";
