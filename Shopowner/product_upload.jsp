    ...
    <body>
        <%
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (f_item.isFormField()) {
                        ...
                        if (field_name.equals("txtfile")) {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\shopowner\\products\\";
                            Random r = new Random();
                ...
                if (value[0].equals("")) {
                    String sel = "select * from tbl_product where  pd_name='" + value[1] + "'";
        ...
        <%
            ...
            String ins = "insert into tbl_product (ct_id,pd_name,pd_brand,pd_image,pd_price,pd_desc,so_id) values('" + value[1] + "','" + value[2] + "','" + value[3] + "','" + fn + "','" + value[4] + "','" + value[5] + "','"+session.getAttribute("ownerid")+"')";
...
boolean a = obj.insert(ins);
        ...
        <%
            ...
            String upt = "update  tbl_product set ct_id='" + value[1] + "',pd_name='" + value[2] + "',pd_brand='" + value[3] + "',pd_image='" + fn + "',pd_price='" + value[4] + "',pd_desc='" + value[5] + "' where pd_id='" + value[0] + "'";
            boolean d = obj.insert(upt);
            if (d) {
        %>
        <script>alert('item updated');window.location.href = 'product.jsp';</script>
        <%
        } else {
        %>
